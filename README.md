...
## 📝 Notes
- The game clears the console between turns for better readability
- Ships are represented by 'B' on the player's board
- Computer's ships are hidden from the player
- Game automatically pauses between turns for better experience
